...
layui.use(["element", "layer", "okUtils", "okTab", "okLayer", "okContextMenu", "okHoliday"], function () {
	...
	$(".layui-footer button.donate").click(function () {
		layer.tab({
			...
			tab: [{
				title: "支付宝",
				content: "<img src='static/admin/images/zfb.jpg' width='200' height='300' style='margin: 0 auto; display: block;'>"
			}, {
				title: "微信",
				content: "<img src='static/admin/images/wx.jpg' width='200' height='300' style='margin: 0 auto; display: block;'>"
			}]
		});
	});
	...
	$("body").on("click", ".layui-footer button.communication, #noticeQQ", function () {
		layer.tab({
			...
			tab: [{
				title: "QQ群3",
				content: "<img src='static/admin/images/qq3.png' width='200' height='300' style='margin: 0 auto; display: block;'/>"
			}, {
				title: "QQ群2（已满）",
				content: "<img src='static/admin/images/qq2.png' width='200' height='300' style='margin: 0 auto; display: block;'/>"
			}, {
				title: "QQ群1（已满）",
				content: "<img src='static/admin/images/qq1.png' width='200' height='300' style='margin: 0 auto; display: block;'/>"
			}]
		});
	});
	...
	$("#alertSkin").click(function () {
		okLayer.open("皮肤动画", "static/admin/pages/system/alertSkin.html", "50%", "45%", function (layero) {
		}, function () {
		});
	});
	...
	$("#logout").click(function () {
		okLayer.confirm("确定要退出登录吗？", function (index) {
